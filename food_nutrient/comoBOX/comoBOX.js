            ...
            if (verify_limits(limits)) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.length > 0) {
                            for (let index = 0; index < data.length; index++) {
                                let food = data[index].food_name;
                                const newRow = $("<tr>");
                                let food_name = '<p class="text">' + food + '</p>';
                                newRow.append('<td class="tooltip">' + food_name + '</td>');
                                ...
                                newRow.on("click", function () {
                                    ...
                                    $.ajax({
                                        ...
                                        success: function (data) {
                                            console.log(data)
                                            let new_limits = reduce_limits(limits, data);
                                            if (selected_foods.hasOwnProperty(food) && selected_foods[food] > 0) {
                                                ...
                                                cloneRow.on("click", function () {
                                                    ...
                                                    selected_foods[food] -= 1;
                                                    new_limits = increase_limits(new_limits, data);
